        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="SuratRekodSuratMasuk.php" class="active">
              <i class="bi bi-file-earmark-text" style="font-size: 1em; background-color: transparent"></i><span>In Record</span>
            </a>
          </li>
        </ul>
      </li>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb" style="background-color: transparent; margin-bottom: 16px">
          ...
          <li class="breadcrumb-item active">In Record</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        ...
        <div class="col-12">
          <div class="card top-selling">
            <div class="sb">
              <div class="card-body">
                <h5 class="card-title"><strong>IN LETTER RECORD</strong><br />
