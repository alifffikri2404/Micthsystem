...
$pdf->Write(0, 'Laporan Aset Berdaftar', '', 0, 'L', true, 0, false, false, 0);
...
$tbl = '
		<table cellspacing="1" cellpadding="2" border="1" width="100%">
			<tr style="background-color:#CEE3F6;color:#000000;">
				...
				<td align="center" width="45%"><strong>Kategori Aset</strong></td>
				<td align="center" width="40%"><strong>Jenis Aset</strong></td>				
			</tr>
