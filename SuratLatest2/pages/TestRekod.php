...
if (isset($_POST['submit'])) {
	...
	try {
		...
		//$sql = mysql_query("SELECT count(id) as ids FROM tbl_surat_in WHERE YEAR( tarikh_surat ) = YEAR( CURDATE( ) ) ORDER BY id DESC");

		//INI BILA KIRA NO ID TABLE
		$sql = "SELECT id as ids FROM tbl_surat_in WHERE YEAR( tarikh_surat ) = YEAR( CURDATE( ) ) ORDER BY id DESC";
		...
		if (mysqli_num_rows($result) > 0) {
			...
			try {
				...
				$sql1 = "INSERT INTO tbl_surat_in(tarikh_surat, no_ruj_surat, nama_pemohon, nama_penerima, tajuk_surat, 
            ...
            '$text', '$department')";
				...
				$sql11 = "SELECT * FROM tbl_surat_in WHERE no_ruj_surat = '$idnorujsuratFF' AND tarikh_surat = '$InputDateCvt'";
			...
			try {
				...
				$sql11 = "SELECT * FROM tbl_surat_in WHERE no_ruj_surat = '$idnorujsuratFst' AND tarikh_surat = '$InputDateCvt'";
				$result11 = mysqli_query($conn2, $sql11);
				if (mysqli_num_rows($result11) > 0) {
					paparMesejBerjaya($idnorujsuratFF);
				} else {
