...
<head>
  ...
  <title>Register In Letter</title>
...
<body>
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="SuratDaftarSuratMasuk.php" class="active">
              <i class="bi bi-pencil-square" style="font-size: 1em; background-color: transparent"></i><span>Register In</span>
            </a>
          </li>
        </ul>
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
  ...
  <div class="pagetitle">
    <h1>Register In Letter</strong></h1>
    <nav>
...
?>
   <section class="section dashboard">
                ...
                <div class="col-md-12">
                  <!-- General form elements -->
                    ...
                    <form role="form" action="" method="post">
                              ...
                              <div class="col-md-5">
                                <div class="form-group">
                                <label for="exampleInputEmail1" style="font-weight: 400; 'Nunito', sans-serif;">MICTH Refference No: *</label>
                                  <div class="input-group">
                                    <input type="text" style="font-size: 1.4rem; line-height: 1.0; height: 34px"
                              ...
                              <div class="col-md-5">
                                ...
                                <label for="action_by" style="font-weight: 400; 'Nunito', sans-serif;">Action By:</label>
                                  <div class="input-group">
                                  <select style="font-size: 1.4rem; line-height: 1.0; height: 34px; -webkit-appearance: menulist-button; -moz-appearance: menulist-button; appearance: menulist-button;" class="form-control" id="InputTindakanOlehSurat" name="InputTindakanOlehSurat">
                                  ...
                                  <div class="input-group">
                                    <input type="text" style="font-size: 1.4rem; line-height: 1.0; height: 34px"
                                      class="form-control" placeholder= "Person Incharge" id="InputTindakanIndividu" name="InputTindakanIndividu" value=""> <br>
                                  </div>
                                </div>
                              </div>
    ...
    {    
      ...
      $name = isset($_SESSION['user']['First_Name']) ? $_SESSION['user']['First_Name'] : '';
