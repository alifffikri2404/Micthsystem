...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li>
		  ...
		  <ul class="treeview-menu">
            ...
            <li class="active"><a href="pages/tables/kemaskiniaset.php"><i class="fa fa-circle-o"></i> Rekod Aset</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href=""><i class="fa fa-dashboard"></i> i-Surat</a></li>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="pages/forms/dafsuratkeluar.php" class="small-box-footer">Data Lengkap <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		<!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-purple">
            ...
            <a href="pages/tables/laporanis.php" class="small-box-footer">Data Lengkap <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div> 
