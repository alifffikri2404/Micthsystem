            ...
            <div class="card-body">
              ...
              <div class="col-lg-3 col-xs-6" style="padding-left: 0px">
                ...
                <div class="small-box" style="margin-top: 20px; border-radius: 20px 20px;
                  background-color: #AE445A; color: #fff">
                  <div class="inner">
                    <h3 style="font-family: 'Poppins', sans-serif; font-size: 32px;">Barcode</h3>
                  </div>
                  <div class="icon">
                    <i class="bi bi-card-checklist" style="font-size: 0.75em"></i>
                  </div>
                  <a href="barcode.php" class="small-box-footer" style="background-color: transparent; padding: 10px">Barcode<i class="fa fa-arrow-circle-right"></i></a>
                </div>
              </div>
              <div class="col-lg-3 col-xs-6" style="padding-left: 0px">
                <!-- small box -->
                <div class="small-box" style="margin-top: 20px; border-radius: 20px 20px;
                  background-color: #AE445A; color: #fff">
                  <div class="inner">
                    <h3 style="font-family: 'Poppins', sans-serif; font-size: 32px;">excell</h3>
                  </div>
                  <div class="icon">
                    <i class="bi bi-card-checklist" style="font-size: 0.75em"></i>
                  </div>
                  <a href="pages/forms/uploadcsv.php" class="small-box-footer" style="background-color: transparent; padding: 10px">excell <i class="fa fa-arrow-circle-right"></i></a>
                </div>
              </div>
              <!-- settings -->
              <div class="col-lg-3 col-xs-6" style="padding-left: 0px">
