...
$pdf->SetTitle('Registered Asset Types');
...
$pdf->Write(0, 'REGISTERED ASSET TYPES', '', 0, 'L', true, 0, false, false, 0);
...
$sqlvtp = "SELECT kategoritps.nama_kategori, jenis_aset.jenis_aset
FROM jenis_aset
INNER JOIN kategoritps ON jenis_aset.id_kategori = kategoritps.id_kategori";
...
$tbl = '
		<table cellspacing="1" cellpadding="2" border="1" width="100%">
			<tr style="background-color:#CEE3F6;color:#000000;">
				...
				<td align="center" width="45%"><strong>Category</strong></td>
				<td align="center" width="40%"><strong>Asset Type</strong></td>				
			</tr>
