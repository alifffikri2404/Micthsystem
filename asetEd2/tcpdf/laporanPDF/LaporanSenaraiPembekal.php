...
$pdf->SetTitle('Registered Suppliers');
...
$pdf->Write(0, 'REGISTERED SUPPLIERS', '', 0, 'L', true, 0, false, false, 0);
...
$tbl = '
		<table cellspacing="1" cellpadding="2" border="1" width="100%">
			<tr style="background-color:#CEE3F6;color:#000000;">
				...
				<td align="center" width="30%"><strong>Supplier</strong></td>
				<td align="center" width="25%"><strong>Address</strong></td>
				<td align="center" width="20%"><strong>Email</strong></td>
				<td align="center" width="15%"><strong>Phone Number</strong></td>
