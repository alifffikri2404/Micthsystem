...
$pdf->SetTitle('Registered Categories');
...
$pdf->Write(0, 'REGISTERED CATEGORIES', '', 0, 'L', true, 0, false, false, 0);
...
$tbl = '
		<table cellspacing="1" cellpadding="2" border="1" width="100%">
			<tr style="background-color:#CEE3F6;color:#000000;">
				...
				<td align="center" width="50%"><strong>Category Name</strong></td>
				<td align="center" width="20%"><strong>Category Code</strong></td>
