    ...
    <div class="row">
      ...
      <div class="col-12">
        <div class="card top-selling">
          <div class="sb">
          <div class="card-body">
            <h5 class="card-title"><strong>SETTINGS</strong><br/>
            <div class="col-lg-3 col-xs-6" style="padding-left: 0px">
            <!-- small box -->
              <div class="small-box" style="margin-top: 20px; border-radius: 20px 20px;
                background-color: #7D0A0A; color: #fff">
                <div class="inner">
                  <h3 style="font-family: 'Poppins', sans-serif; font-size: 32px;">Category & Type</h3>
                </div>
                <div class="icon">
                  <i class="bi bi-grid-3x3-gap-fill" style="font-size: 0.75em"></i>
                </div>
                <a href="pages/forms/tetapanAset.php" class="small-box-footer" style="background-color: transparent; padding: 10px">Register New Category & Type <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <div class="col-lg-3 col-xs-6" style="padding-left: 0px">
            <!-- small box -->
              <div class="small-box" style="margin-top: 20px; border-radius: 20px 20px;
                background-color: #607274; color: #fff">
                <div class="inner">
                  <h3 style="font-family: 'Poppins', sans-serif; font-size: 32px;">Supplier</h3>
                </div>
                <div class="icon">
                  <i class="bi bi-person" style="font-size: 0.75em"></i>
                </div>
                <a href="pages/forms/dafPembekal.php" class="small-box-footer" style="background-color: transparent; padding: 10px">Register New Supplier <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
          </div>
          </div>
