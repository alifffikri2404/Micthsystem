...
function paparMesejBerjayaAset($idasetFF){
	...
	echo '<script type="text/javascript">alert("Kategori berjaya ditambah.");
				window.location="asetDafCheck.php";</script>';
}
...
{		
	...
	$InputNamaKategori = isset($_POST['InputNamaKategori']) ? $_POST['InputNamaKategori'] : '';
	...
	try
	{
		...
		$sql = mysql_query("SELECT nama_kategori FROM kategoritps WHERE nama_kategori LIKE '%$InputNamaKategori%'");
		...
		if(mysql_numrows($sql) > 0)
		{
			...
			try
			{
				...
				$sql1 = "INSERT INTO kategoritps (nama_kategori) 
				VALUES ('$InputNamaKategori')";				
				$query1 = mysql_query($sql1) or die("Error: " . mysql_error());	

				$sql11 = mysql_query("SELECT * FROM kategoritps WHERE nama_kategori = '$InputNamaKategori'");
...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="treeview active">
		  ...
		  <ul class="treeview-menu">
             <li><a href="pages/forms/dafadu.php"><i class="fa fa-circle-o"></i> Daftar Aset</a></li>
            <li class="active"><a href="asetTPSam.php"><i class="fa fa-circle-o"></i> Rekod Aset</a></li>
			 <li class="active"><a href="pages/forms/asetDaf.php"><i class="fa fa-circle-o"></i> Tetapan</a></li>
          </ul>
        </li>
		<!--<li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="../../homeis.php"><i class="fa fa-dashboard"></i> i-Aset</a></li>
        <li class="active">Rekod Kategori</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
		  <?php
		  $sqlAP = mysql_query("SELECT * FROM kategoritps
		 ...
		 /* $rowYear = mysql_fetch_array($sqlAP);
          ...
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title"><strong>Senarai </strong><strong> Kategori </strong><strong> berdaftar </strong><strong> dalam sistem </strong></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
				...
				<?php				  
					...
					$i = 1 + $off;
					 ...
					 echo '
							...
							<td data-title="Nama Kategori">'.$rowAP['nama_kategori'].'</td>
						 
							<td data-title="Kemaskini"><a href="updatetetapan.php?id_kategori='.$rowAP['id_kategori'].'"><i class="fa fa-pencil"></i></a></td> 
							<td data-title="Padam"><a href="delete.php?id_kategori='.$rowAP['id_kategori'].'"><i class="fa fa-trash"></i></a></td>
							</tr>
						';
				...
				<?php				  
					...
					$i = 1 + $off;
					 ...
					 echo '
							...
							<td data-title="Id Kategori">'.$rowAP['id_kategori'].'</td>
							<td data-title="Nama Kategori">'.$rowAP['nama_kategori'].'</td>
							<td class="numeric" data-title="Jenis Kategori">'.$rowAP['jenis_kategori'].'</td>
							<td class="numeric" data-title="Kemaskini"><a href="pages/forms/dafadu.php"><i class="fa fa-pencil"></i></a></td> 
							<td class="numeric" data-title="Padam">'.$rowAP['id_kategori'].'<i class="fa fa-trash"></i></a></td>
