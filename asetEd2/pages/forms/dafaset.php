                            ...
                            <div class="row">
                              ...
                              <div class="col-md-5">
                                ...
                                <select class="form-select" id="full_id" name="full_id" 
                                  ...
                                  <?php
                                    echo 'Selected category: ' . htmlspecialchars($kategori_id) . '<br>'; // Debug output
                                
                                    $kategori_id = str_pad($kategori_id, 2, '0', STR_PAD_LEFT);
                                
                                    $sqlL = "SELECT * FROM asset_management_vba WHERE `Category ID` = '$kategori_id'";
                                    require('../../configAsetTPS.php');
                                    ...
                                    if($countL > 0)
                                    {
                                      ...
                                      $i = 1 + $off;
                                      while($rowL = mysqli_fetch_array($result)) {		 
                                        $selected = isset($_POST['Full ID (Concatenated ID)']) && $_POST['Full ID (Concatenated ID)'] == $rowL['Full ID (Concatenated ID)'] ? 'selected' : '';
                                        echo '<option value="' . $rowL['Full ID (Concatenated ID)'] . '" ' . $selected . '>' . $rowL['Full ID (Concatenated ID)'] . '</option>';
