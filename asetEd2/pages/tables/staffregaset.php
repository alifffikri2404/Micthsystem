                              ...
                              <tbody>
                                ...
                                while($rowAA = mysqli_fetch_array($resultAA)){
                                  ...
                                  echo '
                                    ...
                                    <td align="center">
                                    <a href="detailsStaff.php?id='.$rowAA['id'].'" title="Info Detail" class="fa fa-info-circle"></a>
                                  </tr>';
                                  $i++;
                                }
                                ?>
                              ...
                              <tbody>
                                ...
                                while($rowBB = mysqli_fetch_array($resultBB)){
                                  ...
                                  echo '
                                    ...
                                    <td align="center">
                                    <a href="detailsStaffreq.php?id='.$rowBB['id'].'" title="Info Detail" class="fa fa-info-circle"></a>
                                  </tr>';
                                  $i++;
                                }
                                ?>
