...
<head>
  ...
  <title>Outgoing Letter Record</title>
...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>View Outgoing Letter Record</strong></h1>
      <nav>
        <ol class="breadcrumb" style="background-color: transparent; margin-bottom: 16px">
          ...
          <li class="breadcrumb-item active">Outgoing Letter Record</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        ...
        <div class="col-12">
          <div class="card top-selling">
            <div class="sb">
              <div class="card-body">
                <h5 class="card-title"><strong>OUTGOING LETTER RECORD</strong><br />
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="box-body" style="margin-top: 10px">
                          ...
                          if ($admin_surat == 1){
                            ...
                            $sqlAP = "SELECT * FROM tbl_surat_out_all 
                            WHERE department_pemohon = '$department' OR department_pemohon = 1
                            ORDER BY id DESC";
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                              <thead>
                                <tr>
                                  ...
                                  <th style="width: 15%;">Letter Ref No.</th>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td data-title="No." style="text-align:center">' . $i . '</td>
                                    <td data-title="Date">' . date('Y-m-d', strtotime($rowAP['tarikh_surat'])) . '</td>
                                  <td data-title="Letter Ref No." >' . $rowAP['no_ruj_surat'] . '</td>
                                  <td data-title="Sender" >' . $rowAP['nama_pemohon'] . '</td>
                                  <td data-title="Recipient" >' . $rowAP['nama_penerima'] . '</td>
                                  <td data-title="Title" >' . $rowAP['tajuk_surat'] . '</td>
                                  <td data-title="Delivery Method" >' . $rowAP['kaedah_penghantaran'] . '</td>
                                  <td data-title="Remarks" >' . $rowAP['remarks'] . '</td>
                                  <td data-title="Action" style="text-align:center">
                                    <a href="SuratEditRekodKeluar.php?id=' . $rowAP['id'] . '">
