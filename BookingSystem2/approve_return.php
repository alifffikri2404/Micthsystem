...
if (isset($_POST['approved'])) {
  $appUpdateQuery = "UPDATE hrm_vehicle_use_registration SET status= 'Selesai' WHERE id='" . $_POST['row_id'] . "'";
...
if (isset($_POST['rejected'])) {
  ...
  $rejUpdateQuery = "INSERT INTO record (id, date, user_id, user_name, purpose, destination, driver_name, vehicle_id, model_plat)
...
<head>
  ...
  <title>Vehicle Return Confirmation</title>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content show " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="approve_return.php" class="active">
      ...
      <div class="row">
        ...
        <div class="col-lg-20">
          <div class="row">
            ...
            <div class="sb">
              <div class="card-body">
                <h5 class="card-title"><strong>VEHICLE RETURN</strong></h5>
                ...
                <table style="border: 2px solid black;" class="table table-bordered">
                  ...
                  <?php
                  $selectQuery = "SELECT * FROM bookings WHERE `status` LIKE 'RETURN VEHICLE'";
                  ...
                  ?>
                      ...
                      <tr>
                        <td><?php echo $i; ?></td>
                        <td> <a><?php echo $row['user_name'];
                                $_SESSION['stuappid'] = $row['user_name']; ?></a></td>
                        <td> <?php echo $row['date']; ?> </td>
                        <td> <?php echo $row['purpose']; ?> </td>
                        <td> <?php echo $row['destination']; ?> </td>
                        <td> <a><?php echo $row['driver_name']; ?></a> </td>
                        <td> <a><?php echo $row['model_plat']; ?></a> </td>

                        <td>
                          <form method="post" action="">
                            <input type="hidden" name="row_id" value="<?= $row['id']; ?>" />
                            <button class="btn btn-danger" type="submit" name="rejected">CONFIRM</button>
                          </form>
                        </td>
                      </tr>
                      <?php
