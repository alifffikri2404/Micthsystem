              ...
              <div class="card recent-sales">
                ...
                <div class="card-body">
                  ...
                  <ul class="box-info">
                    ...
                    <li>
                      <?php
                      $sql1 = "SELECT * FROM management_room WHERE status ='Reserved'";
                  ...
                  <div class="table-data">
                    <div class="order">
                      ...
                      <table class="table" id="DataTable">
                        ...
                        <tbody>
                          <?php
                          $selectQuery = "SELECT * FROM `management_room` WHERE 1=1";
                          ...
                          $selectQuery = "SELECT * FROM management_room 
                                   WHERE status NOT IN ('Reject', 'Release', 'Canceled') 
                                   AND (start_date > '$current_date' OR (start_date = '$current_date' AND end_time >= '$current_time'))";
                          ...
                          ?>
                            ...
                            ?>
                            <tr>
                              <td colspan="5">No activity here</td>
                            </tr>
                          <?php
                          }
                          ?>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h1 class="modal-title fs-5" id="exampleModalLabel">Please
                                provide the reason for the rejection.</h1>
