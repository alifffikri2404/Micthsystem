                            ...
                            <div class="input-group">
                              ...
                              <div class="col-md-5">
                                <div class="form-group">
                                 ...
                                 <div class="input-group">
                                    <input type="text" style="font-size: 1.4rem; line-height: 1.0; height: 34px"
                                      class="form-control" id="InputNoRujukanSuratTgh" name="InputNoRujukanSuratTgh" placeholder="Type subunit" oninput="checkInput()"><br>
                                  </div>
                                  <div class="input-group">
                              ...
                              <div class="col-md-5">
                                <div class="form-group">
                                  <label for="exampleInputEmail1" style="font-weight: 400; 'Nunito', sans-serif;">Recipient / Department / Agency:</label>
                                    <div class="input-group">
                                      <input type="text" style="font-size: 1.4rem; line-height: 1.0; height: 34px"
                                      class="form-control" id="InputNamaPenerima" name="InputNamaPenerima" placeholder="Recipient Name" required ><br>
                                    </div>
                                  </div>
                                </div>
                                  <div class="col-md-5">
