...
if(isset($_POST['btn-update']))
{
  ...
  $reason_id = $_POST['reason_lupus'];

  $sqlSB = "UPDATE disposal_aset
    SET tarikh_lupus = '$tarikh_lupus', reason = '$reason_id',
      nilai_lupus = '$nilai_lupus', pihak_lupus = '$pihak_lupus'
    WHERE aset_id = '$aset_id'";

  $resultSB = mysqli_query($conn2, $sqlSB);
...
{
 header("Location: laporlupus.php");
}
...
<head>
  ...
  <title>Update Disposal Details</title>
...
<body>
  ...
  <div class="pagetitle">
    <h1>Update Disposal Record</strong></h1>
    <nav>
      <ol class="breadcrumb" style="background-color: transparent; margin-bottom: 16px">
        ...
        <li class="breadcrumb-item active">Update Disposal</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
                    ...
                    <div class="row">
                      <div class="col-md-5">
                        <div class="form-group">
                          <label for="kategori" class="title-label">Category:</label>
                            <input type="text" class="form-control placeholder-label" id="kategori" name="kategori" placeholder="CATEGORY" 
                      ...
                      <div class="col-md-5">
                        ...
                        <label for="jenis" class="title-label">Asset Type:</label>
                            <input type="text" class="form-control placeholder-label" id="jenis" name="jenis" placeholder="ASSET TYPE" 
                      ...
                      <div class="col-md-5">
                        <div class="form-group">
                          <label for="exampleInputPassword1" class="title-label">Asset Number:</label>
                            <input type="text" class="form-control placeholder-label" id="InputNoSiriAwal" name="InputNoSiriAwal" placeholder="ASSET NUMBER"
                      ...
                      <div class="col-md-5">
                        <div class="form-group">
                          <label for="exampleInputPassword1" class="title-label">Asset Name:</label>
                            <input type="text" class="form-control placeholder-label" id="nama_aset" name="nama_aset" placeholder="ASSET NAME"
                          ...
                          <div class="col-md-5">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                <input type="text" class="form-control placeholder-label" id="tarikh_lupus" name="tarikh_lupus"
                                  value="<?php echo $fetched_row['tarikh_lupus'];?>" readonly>
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control placeholder-label" id="nilai_harga" name="nilai_harga" placeholder="VALUE"
                                  value="<?php echo $fetched_row['nilai_lupus'];?>" oninput="formatDisposalValue(this)">
                              </div>
                            </div>
                            <script>
                            ...
                            <div class="form-group">
                              <label for="exampleInputPassword1" class="title-label">Person-in-Charge:</label>
                                <input type="text" class="form-control placeholder-label" id="pihak_lupus" name="pihak_lupus" placeholder="PIC"
                                  value="<?php echo $fetched_row['pihak_lupus'];?>">
                            </div>
                          </div>
                          <div class="col-md-5">
                            <div class="form-group">
                              <label for="exampleInputPassword1" class="title-label">Reason for Dispose:</label>
                                ...
                                $sqlA4 = "SELECT * FROM disposal_reason";
                                $result4 = mysqli_query($conn2, $sqlA4);

                                while ($row = mysqli_fetch_assoc($result4)) {
                                  $reason_id = $row['id_reason'];
                                  $reason_description = $row['reason'];
                                  $checked = ($reason_id == $reason_lupus) ? 'checked' : '';

                                  echo '<br>';
                                  echo '<input class="form-check-input" id="reason_lupus" name="reason_lupus" value="' . $reason_id . '" type="radio" ' . $checked . '>&nbsp;';
                                  echo '<label class="form-check-label" for="reason_lupus" style="font-weight: 500; font-size: 1.6rem">' . $reason_description . '</label>';
                                }
                                ?>
                            </div>
                          </div>
