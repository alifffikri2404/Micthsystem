...
if(isset($_POST['submit2']))
{
  ...
  $sqlBB = "UPDATE tbl_daftar_aset SET status_aset = '$status_aset'
    WHERE id = '$aset_id'";
  $resultBB = mysqli_query($conn2, $sqlBB);

  if($resultBA && $resultBB){
?>
                        ...
                        <div class="form-group">
                          <label for="kategori" style="font-weight: 400; 'Nunito', sans-serif;">Category:</label>
                            <input type="text" style="text-transform:uppercase; font-size: 1.4rem; line-height: 1.0; height: 34px"
                              ...
                              value="<?php echo $fetched_row['nama_kategori'];?>" readonly>
                        </div>
                      </div>
                      <div class="col-md-5">
                        <div class="form-group">
