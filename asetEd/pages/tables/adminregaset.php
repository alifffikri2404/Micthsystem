    ...
    <div class="row">
      ...
      <div class="col-12">
        <div class="card top-selling">
          <div class="sb">
            <div class="card-body">
              <h5 class="card-title"><strong>REGISTERED ASSET</strong><br/>
                        ...
                        <div class="row">
                          <form action="" name="form1" method="post" target="_blank">
                            <?php
                              ...
                              $sqlAA = "SELECT * FROM tbl_daftar_aset
                            ...
                            <table id="datatable" class="table table-bordered table-striped">
                              ...
                              <tbody>
                                ...
                                while($rowAA = mysqli_fetch_array($resultAA)){
                                  ...
                                  $kategori_aset = $rowAA['kategori_aset'];
                                  if (!empty($kategori_aset)){
                                    $sqlAC = "SELECT * FROM kategoritps 
                                      WHERE id_kategori = $kategori_aset";
                                    $resultAC = mysqli_query($conn2, $sqlAC);
                                    if ($resultAC){
                                      $row = mysqli_fetch_assoc($resultAC);
                                      $kategori_aset2 = $row['nama_kategori'];
                                    } else {
                                      $kategori_aset2 = "None";
                                    }
                                  } else {
                                  ...
                                  echo '
                                    ...
                                    <td data-title="Category">'.strtoupper($kategori_aset2).'</td>
                                    <td data-title="Type">'.strtoupper($rowAA['jenis_aset']).'</td>
                                    <td data-title="Asset No.">'.strtoupper($rowAA['no_aset']).'</td>
                                    <td data-title="Name">'.strtoupper($rowAA['nama_aset']).'</td>	
                                    <td data-title="Serial No." >'.$rowAA['no_siri'].'</td>
                                    <td data-title="Handover Date" >'.$rowAA['tarikh_serahan'].'</td>
                                    <td data-title="Status" style="'.$statusStyle.'">'.strtoupper($status_aset).'</td>

                                    <td align="center">
                                    <a href="detailsAdmin.php?id='.$rowAA['id'].'" title="Info Detail" class="fa fa-info-circle"></a>
                                  </tr>';
                                  $i++;
                                }
                                ?>
      ...
      <div class="col-12 mt-10">
        <div class="card top-selling">
          <div class="sb">
            <div class="card-body">
              <h5 class="card-title"><strong>REQUESTED ASSET</strong><br/>
                        ...
                        <div class="row">
                          <form action="" name="form2" method="post" target="_blank">
                            <?php
                              ...
                              $sqlBB = "SELECT * FROM req_aset
                              WHERE nama_kakitangan = '$fullname'";

                              $resultBB = mysqli_query($conn2, $sqlBB);
                              $countBB = mysqli_num_rows($resultBB);
                              ...
                              <tbody>
                                ...
                                while($rowBB = mysqli_fetch_array($resultBB)){
                                  ...
                                  echo '
                                    ...
                                    <td align="center">
                                    <a href="detailsAdminreq.php?id='.$rowBB['id'].'" title="Info Detail" class="fa fa-info-circle"></a>
                                  </tr>';
                                  $i++;
                                }
                                ?>
