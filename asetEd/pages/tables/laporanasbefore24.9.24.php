      ...
      <div class="row">
        ...
        <div class="col-12">
          <div class="card top-selling">
            <!-- <div class="sb"> -->
            <div class="card-body">
              <h5 class="card-title"><strong>REPORT</strong><br />
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <select class="form-select" id="kategori" name="kategori" style="font-size: 1.4rem; line-height: 1.0; height: 34px" placeholder="CATEGORY NAME">
                                <?php
          ...
          <div class="card top-selling">
            ...
            <div class="card-body">
              <form role="form" action="dafasetcheck.php" method="post">
                <h5 class="card-title"><strong>ASSET RECORD DATA MANAGEMENT</strong><br />
                  <!-- View record data based on category -->

                  <!--------------------------------- IF ELSE STATEMENT TO DIFFERENTIATE CATEGORY DATATABLE ---------------------------->
                  <!-- Kategori Aset - KOMPUTER (ID = 32) -->
                  <?php
                  if ($kategori_id == 32) {
                  ?>
                    <!-- Table of asset record information -->
...
WHERE kategori_aset = '$kategori_id'
ORDER BY tbl_daftar_aset.id DESC";
    ...
    <td data-title="Staff Name" >' . strtoupper($rowAB['nama_kakitangan']) . '</td>
...
ORDER BY tbl_daftar_aset.id DESC";
  ...
  ';
                    ...
                    <!-- Kategori Aset - KELENGMKAPAN PEJABAT (ID = 34) 
                  PERALATAN (ID = 35)
                  KEMUDAHAN (ID = 36) -->
                  <?php
                  } else if ($kategori_id == 34 || $kategori_id == 35 || $kategori_id == 36) {
                  ?>
                    <!-- Table of asset record information -->
                    <div class="col-lg-20" style="margin-top: 10px">
                      <div class="col-md-12 mt-10" style="margin-top: 10px; margin-bottom: 20px">
...
ORDER BY tbl_daftar_aset.id DESC";
                                      ...
                                      while ($rowAB = mysqli_fetch_array($resultAB)) {
                                        ...
                                        if (!empty($lokasi_jabatan)) {
                                          $sqlAB2 = "SELECT * FROM empdept WHERE dept_id = $lokasi_jabatan";
                                          $resultAB2 = mysqli_query($conn2, $sqlAB2);
    ...
    <td data-title="Asset Name">' . strtoupper($rowAB['nama_aset']) . '</td>	
    <td data-title="Staff Name" >' . strtoupper($rowAB['nama_kakitangan']) . '</td>
    <td data-title="Plate No." >' . strtoupper($rowAB['no_siri']) . '</td>
    <td data-title="Status" style="' . $statusStyle . '">' . strtoupper($status_aset) . '</td>
