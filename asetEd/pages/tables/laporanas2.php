...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> i-Aset</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box box-success">
            ...
            <!-- /.box-header -->
            <div class="box-body">
			<form action="../../tcpdf/laporanPDF/laporanas2pdf.php" name="form2" method="post" target="_blank">
			<?php
...
$sqlap2=mysql_query($sqlAP);
			$countAP = mysql_num_rows($sqlap2);
			if($countAP > 0)
			{
			?>
				...
				<?php				  
					...
					$i = 1 + $off;
					 ...
					 echo '
							...
							&nbsp;&nbsp;&nbsp;
							<a href="padamaset.php?id='.$rowAP['id'].'"  title="Padam" class="fa fa-trash-o" onclick="return confirmation();"></a>
                            &nbsp;&nbsp;&nbsp;
						   <a href="infolanjut.php?id='.$rowAP['id'].'"  title="info lanjut" class="fa fa-info-circle"></a>
						   &nbsp;&nbsp;&nbsp;
