...
if (isset($_POST['submit2'])) {
    $aset_id = mysqli_real_escape_string($conn, $_GET['id']);
    $kategori_aset = mysqli_real_escape_string($conn, $_POST['kategori']);
    $jenis_aset = mysqli_real_escape_string($conn, $_POST['jenis']);
    $no_aset = mysqli_real_escape_string($conn, $_POST['InputNoSiriAwal']);
    $nama_aset = mysqli_real_escape_string($conn, $_POST['nama_aset']);
   
   
    $tarikh_lupus = mysqli_real_escape_string($conn, $_POST['tarikh_lupus']);
    $nilai_lupus = mysqli_real_escape_string($conn, $_POST['nilai_harga']);
    $pihak_lupus = mysqli_real_escape_string($conn, $_POST['pihak_lupus']);
    $reason_lupus = mysqli_real_escape_string($conn, $_POST['reason_lupus']);

    $status_aset = 'Inactive';

    // Insert data into disposal_aset table
    $sqlBA = "INSERT INTO disposal_aset (aset_id, kategori_aset, jenis_aset, no_aset, nama_aset, 
         tarikh_lupus, reason, nilai_lupus, pihak_lupus)
        VALUES ('$aset_id', '$kategori_aset', '$jenis_aset', '$no_aset', '$nama_aset', '$tarikh_lupus', '$reason_lupus', '$nilai_lupus', '$pihak_lupus')";
    $resultBA = mysqli_query($conn2, $sqlBA);

    // Update status in asset_management_vba
    $sqlBB = "UPDATE asset_management_vba 
              SET status = '$status_aset' 
              WHERE `Full_ID (Concatenated ID)` = '" . mysqli_real_escape_string($conn2, $aset_id) . "'";
    $resultBB1 = mysqli_query($conn2, $sqlBB);

    // Update status in tbl_daftar_aset
    $sqlBB2 = "UPDATE tbl_daftar_aset 
               SET status_aset = '$status_aset' 
               WHERE id = '$aset_id'";
    $resultBB2 = mysqli_query($conn2, $sqlBB2);

    if ($resultBA && $resultBB1 && $resultBB2) {
        ?>
    ...
    <div class="row">
                        ...
                        <div class="form-group">
                          <label for="exampleInputPassword1" class="title-label">Asset Number:</label>
                            <input type="text" style="font-size: 1.4rem; line-height: 1.0; height: 34px"
                              ...
                              value="<?php echo $fetched_row['Full_ID (Concatenated ID)'];?>" readonly>
                        </div>
                      </div>
                      <div class="col-md-5">
                        <div class="form-group">
      ...
      <div class="col-12 mt-10">
        <div class="card top-selling">
          <div class="sb">
            <div class="card-body">
              <h5 class="card-title"><strong>REGISTER NEW DISPOSAL</strong><br/>
                    ...
                    <!-- Form start -->
                          ...
                          <div class="col-md-5">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                <input type="text" class="form-control placeholder-label" id="tarikh_lupus" name="tarikh_lupus" value="<?php echo date("Y-m-d"); ?>" readonly>
                          ...
                          <div class="col-md-5">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control placeholder-label" id="nilai_harga" name="nilai_harga" placeholder="VALUE"
                          ...
                          <div class="col-md-5">
                            <div class="form-group">
                              <label for="exampleInputPassword1" class="title-label">Person-in-Charge:</label>
                                <input type="text" class="form-control placeholder-label" id="pihak_lupus" name="pihak_lupus" placeholder="PIC">
                            </div>
                          </div>
                          <!-- <div class="col-md-5">
                            <div class="form-group">
                              <label for="exampleInputPassword1" style="font-weight: 400; 'Nunito', sans-serif;">Reason for Dispose:</label>
                                <textarea class="form-control" style="font-size: 1.4rem; line-height: 1.8"
                                  rows="3" cols="50" id="reason_lupus" name="reason_lupus" placeholder="REASON" ></textarea>
                              </div>
                          </div> -->
                          <div class="col-md-5">
                            <div class="form-group">
                              <label for="exampleInputPassword1" class="title-label">Reason for Dispose:</label>
                                <br>
                                  <input class="form-check-input" id="reason_lupus" name="reason_lupus" value="1" type="radio"> 
                                  <label class="form-check-label" for="reason_lupus" style="font-weight: 500; font-size: 1.6rem">For Sale</label>
                                <br>
                                  <input class="form-check-input" id="reason_lupus" name="reason_lupus" value="2" type="radio"> 
                                  <label class="form-check-label" for="reason_lupus" style="font-weight: 500; font-size: 1.6rem">Damaged Asset</label>
                                <br>
                                  <input class="form-check-input" id="reason_lupus" name="reason_lupus" value="3" type="radio">
                                  <label class="form-check-label" for="reason_lupus" style="font-weight: 500; font-size: 1.6rem">For Donation</label>
                              </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-2"> <!-- Adjust the width of the button column -->
                        <div class="form-group" style="margin-top: 10px">
                          <button type="submit" name="submit2" id="submit2" class="btn btn-primary btn-lg" style="font-size: 15px">Register</button>
