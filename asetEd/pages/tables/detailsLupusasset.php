                          ...
                          <div class="col-md-5">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                <input type="text" style="font-size: 1.4rem; line-height: 1.0; height: 34px"
                                  class="form-control" id="tarikh_lupus" name="tarikh_lupus" value="<?php echo date("Y-m-d"); ?>" readonly>
                          ...
                          <div class="col-md-5">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" style="font-size: 1.4rem; line-height: 1.0; height: 34px"
                                  class="form-control" id="nilai_harga" name="nilai_harga" placeholder="VALUE"
                          ...
                          <div class="col-md-5">
                            <div class="form-group">
                              <label for="exampleInputPassword1" style="font-weight: 400; 'Nunito', sans-serif;">Person-in-Charge:</label>
                                <input type="text" style="font-size: 1.4rem; line-height: 1.0; height: 34px"
                                  class="form-control" id="pihak_lupus" name="pihak_lupus" placeholder="PIC">
                            </div>
                          </div>
                          <!-- <div class="col-md-5">
                            <div class="form-group">
