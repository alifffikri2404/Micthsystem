...
<body>
  ...
  <div class="pagetitle">
    <h1>View Disposal Record</strong></h1>
    <nav>
      <ol class="breadcrumb" style="background-color: transparent; margin-bottom: 16px">
        ...
        <li class="breadcrumb-item active">Disposal Report</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
    ...
    <div class="row">
      ...
      <div class="col-12">
        <div class="card top-selling">
          ...
          <!-- <div class="sb"> -->
            <div class="card-body">
              <h5 class="card-title"><strong>VIEW ASSET DISPOSAL</strong><br/>
                              ...
                              <tbody>
                                ...
                                while($rowAA = mysqli_fetch_array($resultAA)){
                                  ...
                                  echo '
                                    ...
                                    <td data-title="Disposal Date" >'.$rowAA['tarikh_lupus'].'</td>
                                    <td data-title="Value" >'.'RM '.$rowAA['nilai_lupus'].'</td>
                                    <td data-title="PIC" >'.$rowAA['pihak_lupus'].'</td>
                                    <td data-title="Reason" >'.$reason_lupus2.'</td>

                                    <td align="center">
                                    <a href="kemaskiniLupus.php?id='.$rowAA['aset_id'].'" title="Update" class="fa fa-pencil"></a>
                                    &nbsp;&nbsp;
                                    <a href="detailsLupus.php?id='.$rowAA['aset_id'].'" title="Info Detail" class="fa fa-info-circle"></a>
                                    &nbsp;&nbsp;
                                  </tr>';
                                  $i++;
                                }
