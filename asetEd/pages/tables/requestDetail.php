...
if(isset($_POST['submitA']))
{
  ...
  $status_req = 'Approved';
  $tarikh_check = $_POST['tarikh_check'];
  $sqlP = "UPDATE req_aset SET tarikh_check = '$tarikh_check', 
    status_req = '$status_req' WHERE id = '$aset_id'";

  $resultP = mysqli_query($conn2, $sqlP);
  
  if($resultP){
?>
  <script type="text/javascript">
    alert('Asset request has been approved!');
    window.location.href = '../tables/staffrequest.php';
  </script>
<?php
  } else {
?>
  <script type="text/javascript">
    alert('Failed to approve asset request!');
  </script>
<?php
  }
}
...
?>
  <script type="text/javascript">
    alert('Asset request has been rejected!');
    window.location.href = '../tables/staffrequest.php';
  </script>
<?php
  } else {
?>
  <script type="text/javascript">
    alert('Failed to reject asset request!');
  </script>
<?php
  }
}
...
<head>
  ...
  <title>Staff Request Details</title>
  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb" style="background-color: transparent; margin-bottom: 16px">
        ...
        <li class="breadcrumb-item"><a href="../../pages/tables/staffrequest.php">Staff Request</a></li>
        ...
        <div class="card top-selling">
          <div class="sb">
            <div class="card-body">
                ...
                <div class="col-md-12">
                  ...
                  <div class="box-body">
                    <div class="row">
                      ...
                      <div class="col-md-5">
                        <div class="form-group" style="display: flex; align-items: center;">
                          <label for="exampleInputEmail1" class="title-label">Checked Date:</label>
                      ...
                      <div class="col-md-5">
                        <div class="form-group">
                          <label for="exampleInputPassword1" class="title-label">Justification:</label>
                            ...
                            ?>
                          <textarea class="form-control placeholder-label" rows="3" cols="50" id="reason_req" name="reason_req" placeholder="REASON" readonly><?php echo $reason_req2;?></textarea>
                        </div>
                      </div>
                      <div class="col-md-5">
                        <div class="form-group">
                      ...
                      <div class="col-md-5">
                        <div class="form-group">
                          <label for="exampleInputEmail1" class="title-label"></label>
                            <input type="hidden" class="form-control placeholder-label" id="tarikh_check" name="tarikh_check" value="<?php echo date("Y-m-d"); ?>" readonly>
                        </div>
                      </div>
              ...
              <!-- if else untuk display approve / reject button -->
              <?php
              if ($status_request == 'Processing'){
              ?>
              <div class="col-md-2" style="margin-bottom: 20px">
                <div class="form-group">
                  <button type="submit" name="submitA" id="submitA" class="btn btn-success btn-lg" style="font-size: 15px">Approve</button>
                  <button type="submit" name="submitB" id="submitB" class="btn btn-danger btn-lg" style="font-size: 15px">Reject</button>
                </div>
              </div>
              <?php
              }
