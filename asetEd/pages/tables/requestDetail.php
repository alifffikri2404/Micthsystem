                ...
                <div class="col-md-12">
                  ...
                  <div class="box-body">
                    <div class="row">
                      ...
                      <div class="col-md-5">
                        <div class="form-group">
                          <label for="exampleInputEmail1" style="font-weight: 400; 'Nunito', sans-serif;"></label>
                            <input type="hidden" style="font-size: 1.4rem; line-height: 1.0; height: 34px"
                              class="form-control" id="tarikh_check" name="tarikh_check" value="<?php echo date("Y-m-d"); ?>" readonly>
                        </div>
                      </div>
