...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="treeview active">
		  ...
		  <ul class="treeview-menu">
            ...
            <li class="active"><a href="laporanip.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <i class="fa fa-circle-o"></i>Laporan</a></li>
          </ul>
        </li>
		<?php }	?>
		<li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="../../homeis.php"><i class="fa fa-dashboard"></i> i-Pay</a></li>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
		  <?php
		  $sqlAP = mysql_query("SELECT * FROM tbl_payment_cert
						ORDER BY tarikh_payment_cert ASC");					
		  $rowYear = mysql_fetch_array($sqlAP);
		  $tarikhipay = $rowYear['tarikh_payment_cert'];
		  if($tarikhipay <> "")
		  {
		  $tarikhipayY = date("Y", strtotime($tarikhipay));
		  }else{
		  }
		  ?>
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title">Data <strong><i>Payment Cert</i></strong> Yang Dikeluarkan 
			  <?php
			  if($tarikhipay <> "")
			  {
				$tarikhipayY = date("Y", strtotime($tarikhipay));
			  ?>
			  dari tahun <strong><?php echo $tarikhipayY; ?></strong> hingga tahun <strong><?php echo date('Y');?></h3>
			  <?php
			  }else{
			  ?>
			  bermula tahun <strong><?php echo date('Y');?></h3>
			  <?php
			  }
			  ?>
            </div>
			...
			?>
				...
				<?php				  
					...
					$i = 1 + $off;
					 ...
					 echo '
							...
							<td data-title="Tarikh">'.$rowAP['tarikh_payment_cert'].'</td>
							<td data-title="Certificate Number">'.$rowAP['no_sijil'].'</td>
							<td class="numeric" data-title="Contractor">'.$rowAP['kontraktor'].'</td>
							<td class="numeric" data-title="Explanation">'.$rowAP['keterangan'].'</td>
							<td class="numeric" data-title="Total Payment (RM)">'.$rowAP['jum_bayaran'].'</td>
							</tr>
						';
			  ...
			  <?php
				  ...
				  echo '				  
					<span>Tiada Rekod No Sijil Bagi Payment Cert Dikeluar.</span>				  
				  ';
			  }
		      ?>
