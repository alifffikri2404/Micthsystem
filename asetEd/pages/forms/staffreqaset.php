  ...
  <aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
      ...
      <ul id="asset-system-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" data-bs-target="#request-asset-nav" data-bs-toggle="collapse" href="#" style="padding: 10px 15px 10px 40px">
            <i class="bi bi-clipboard2-check-fill" style="font-size: 1em"></i></i><span>Request Asset</span>
            <i class="bi bi-chevron-down ms-auto" style="font-size: 1em"></i>
          </a>
          <ul id="request-asset-nav" class="nav-content collapse show" data-bs-parent="#asset-system-nav">
            <li class="nav-item">
              <a class="active" href="../forms/staffreqaset.php" style="padding-left: 60px">
