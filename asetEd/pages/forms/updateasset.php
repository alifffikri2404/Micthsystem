                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control placeholder-label" id="model" name="model" value="<?php echo htmlspecialchars($fetched_row['Model']); ?>" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-5">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" class="form-control placeholder-label" id="dopurchase" name="dopurchase" value="<?php echo htmlspecialchars($fetched_row['DATE_OF_PURCHASE']); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-5">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="staffname" class="form-control placeholder-label" placeholder="Staff Name" name="staffname" oninput="filterStaff()" />
                                                ...
                                                <style>
                                                            ...
                                                            <div class="col-md-5">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-select placeholder-label" id="nama_pembekal" name="supplier" onchange="updatePembekal()">
