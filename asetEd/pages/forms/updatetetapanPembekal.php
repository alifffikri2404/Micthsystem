...
if (isset($_GET['id_pembekal'])) {
  $sql_query = "SELECT * FROM tbl_pembekal WHERE id_pembekal=" . $_GET['id_pembekal'];
...
if (isset($_POST['btn-update'])) {
  ...
  if (isset($_GET['id_pembekal'])) {
      ...
      $id_pembekal = $_GET['id_pembekal'];
      $nama_pembekal = $_POST['nama_pembekal'];
      $email_pembekal = $_POST['email_pembekal'];
      $notel_pembekal = $_POST['notel_pembekal'];
      $alamat_pembekal = $_POST['alamat_pembekal'];


      $sql_query = "UPDATE tbl_pembekal SET nama_pembekal='$nama_pembekal', emel_pembekal='$email_pembekal', notel_pembekal='$notel_pembekal', alamat_pembekal='$alamat_pembekal' WHERE id_pembekal=$id_pembekal";
      ...
      if ($result) {
          try {
              $sql = "SELECT * FROM tbl_pembekal WHERE nama_pembekal LIKE '%$nama_pembekal%' AND id_pembekal LIKE '%$id_pembekal%'";
              ...
              if (mysqli_num_rows($result1) > 0) {
                  ...
                  <script type="text/javascript">
                      ...
                      window.location.href = 'dafPembekal.php';
                  </script>
                  <?php
              } else {
                  ?>
              ...
              echo 'Caught exception update: ',  $e->getMessage(), "\n";
          }
      } else {
          ?>
          <script type="text/javascript">
      ...
      echo "Error: 'id_pembekal' not set in the URL.";
  }
}
  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb" style="background-color: transparent; margin-bottom: 16px">
        ...
        <li class="breadcrumb-item"><a href="../../pages/forms/dafPembekal.php">Supplier</a></li>
    ...
    <div class="row">
      ...
      <div class="col-12">
        <div class="card top-selling">
          <div class="sb">
          <div class="card-body">
            <h5 class="card-title"><strong>UPDATE NEW SUPPLIER</strong><br/>

            <!-- View update supplier field form -->
                      ...
                      <div class="row">
                        <div class="col-md-5">
                          <div class="form-group">
                            <label for="exampleInputPassword1" style="font-weight: 400; 'Nunito', sans-serif;">Supplier Name:</label>
                              <input type="text" class="form-control" style="font-size: 1.4rem; line-height: 1.0; height: 34px"
                                id="nama_pembekal" name="nama_pembekal" placeholder="SUPPLIER NAME" value="<?php echo $fetched_row['nama_pembekal']; ?>">
                          </div>
                        </div>
                        <div class="col-md-5">
                          <div class="form-group">
                            <label for="exampleInputPassword1" style="font-weight: 400; 'Nunito', sans-serif;">Phone Number:</label>
                              <input type="text" class="form-control" style="font-size: 1.4rem; line-height: 1.0; height: 34px"
                                id="notel_pembekal" name="notel_pembekal" placeholder="SUPPLIER PHONE NO." value="<?php echo $fetched_row['notel_pembekal']; ?>">
                          </div>
                        </div>
                        <div class="col-md-5">
                          <div class="form-group">
                            <label for="exampleInputPassword1" style="font-weight: 400; 'Nunito', sans-serif;">Email:</label>
                              <input type="text" class="form-control" style="font-size: 1.4rem; line-height: 1.0; height: 34px"
                                id="email_pembekal" name="email_pembekal" placeholder="SUPPLIER EMAIL" value="<?php echo $fetched_row['emel_pembekal']; ?>">
                          </div>
                        </div>
                        <div class="col-md-5">
                          <div class="form-group">
                            <label for="exampleInputPassword1" style="font-weight: 400; 'Nunito', sans-serif;">Address:</label>
                              <textarea class="form-control" rows="3" cols="50" id="alamat_pembekal" name="alamat_pembekal"
                                style="font-size: 1.4rem; line-height: 1.8"
                                placeholder="SUPPLIER ADDRESS"><?php echo $fetched_row['alamat_pembekal']; ?></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
