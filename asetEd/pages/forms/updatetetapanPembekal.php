                        ...
                        <div class="col-md-5">
                          <div class="form-group">
                            <label for="exampleInputPassword1" class="title-label">Supplier Name:</label>
                              <input type="text" class="form-control placeholder-label" id="nama_pembekal" name="nama_pembekal" placeholder="SUPPLIER NAME" value="<?php echo $fetched_row['nama_pembekal']; ?>">
                          </div>
                        </div>
                        <div class="col-md-5">
                          <div class="form-group">
                            <label for="exampleInputPassword1" class="title-label">Phone Number:</label>
                              <input type="text" class="form-control placeholder-label" id="notel_pembekal" name="notel_pembekal" placeholder="SUPPLIER PHONE NO." value="<?php echo $fetched_row['notel_pembekal']; ?>">
                          </div>
                        </div>
                        <div class="col-md-5">
                          <div class="form-group">
                            <label for="exampleInputPassword1" class="title-label">Email:</label>
                              <input type="text" class="form-control placeholder-label" id="email_pembekal" name="email_pembekal" placeholder="SUPPLIER EMAIL" value="<?php echo $fetched_row['emel_pembekal']; ?>">
                          </div>
                        </div>
                        <div class="col-md-5">
                          <div class="form-group">
                            <label for="exampleInputPassword1" class="title-label">Address:</label>
                              <textarea class="form-control placeholder-label" rows="3" cols="50" id="alamat_pembekal" name="alamat_pembekal"
