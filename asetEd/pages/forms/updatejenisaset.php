                      ...
                      <div class="row">
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="InputJenisKategori" class="title-label">Category Name:</label>
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="InputJenisKategori" class="title-label">Asset Type:</label>
                            <input type="text" class="form-control placeholder-label" name="jenis_aset" 
				                      placeholder="TYPE NAME" value="<?php echo $fetched_row['type_aset']; ?>" />
                          </div>
                        </div>
                      </div>
                    </div>
