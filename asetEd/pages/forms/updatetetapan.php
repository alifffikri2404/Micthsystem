...
{
 $sql_query="SELECT * FROM kategoritps WHERE id_kategori=".$_GET['id_kategori'];
...
if(isset($_POST['btn-update']))
{
 ...
 $kod_kategori = $_POST['kod_kategori'];
 // echo $id_kategori = $_POST['id_kategori'];
 

 // variables for input data

 // sql query for update data into database
 $sql_query = "UPDATE kategoritps SET nama_kategori='$nama_kategori',kod='$kod_kategori' WHERE id_kategori=".$_GET['id_kategori'];
 // sql query for update data into database
 $result4 = mysqli_query($conn2,$sql_query);
 // sql query execution function
 if(($result4))
 {
	try
	{
		$sql = "SELECT * FROM kategoritps WHERE nama_kategori LIKE '%$nama_kategori%' AND kod LIKE '%$kod_kategori%'";
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="../../homeaset.php" class="logo d-flex align-items-center">
        <img src="../../../logomicth.png" alt="MICTH">
    ...
    <div class="row">
      ...
      <div class="col-12">
        <div class="card top-selling">
          <div class="sb">
          <div class="card-body">
            <h5 class="card-title"><strong>UPDATE NEW ASSET CATEGORY</strong><br/>
                      ...
                      <div class="row">
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="exampleInputPassword1" class="title-label">Category Name:</label>
                            <input type="text" class="form-control placeholder-label" name="nama_kategori" 
				                      placeholder="CATEGORY NAME" value="<?php echo $fetched_row['nama_kategori']; ?>" />
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="exampleInputPassword1" class="title-label">Category Code:</label>
                            <input type="text" class="form-control placeholder-label" name="kod_kategori" 
