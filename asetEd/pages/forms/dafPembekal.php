                          ...
                          <div class="form-group">
                            <label for="exampleInputPassword1" style="font-weight: 400; 'Nunito', sans-serif;">Supplier Name:</label>
                              <input type="text" style="font-size: 1.4rem; line-height: 1.0; height: 34px"
                                class="form-control" id="Inputnama_pembekal" name="Inputnama_pembekal" placeholder="SUPPLIER NAME">
                          </div>
                        </div>
                        <div class="col-md-5">
                          <div class="form-group">
                            <label for="exampleInputPassword1" style="font-weight: 400; 'Nunito', sans-serif;">Phone Number:</label>
                              <input type="text" style="font-size: 1.4rem; line-height: 1.0; height: 34px"
                                class="form-control" id="Inputnotel_pembekal" name="Inputnotel_pembekal" placeholder="SUPPLIER PHONE NO.">
                          </div>
                        </div>
                        <div class="col-md-5">
                          <div class="form-group">
                            <label for="exampleInputPassword1" style="font-weight: 400; 'Nunito', sans-serif;">Email:</label>
                              <input type="text" style="font-size: 1.4rem; line-height: 1.0; height: 34px"
                                class="form-control" id="Inputemail_pembekal" name="Inputemail_pembekal" placeholder="SUPPLIER EMAIL">
                          </div>
                        </div>
                        <div class="col-md-5">
                          <div class="form-group">
                            <label for="exampleInputPassword1" style="font-weight: 400; 'Nunito', sans-serif;">Address:</label>
                              <textarea class="form-control" style="font-size: 1.4rem; line-height: 1.8"
                                rows="3" cols="50" id="Inputalamat_pembekal" name="Inputalamat_pembekal" placeholder="SUPPLIER ADDRESS" ></textarea>
                            </div>
                        </div>
                      </div>
                    </div>
