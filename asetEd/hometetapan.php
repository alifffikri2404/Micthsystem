 ...
 <aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
      ...
      <ul id="asset-system-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
        <li class="nav-item">
          <a class="nav-link collapsed" href="pages/tables/staffregaset.php">
            <i class="bi bi-archive-fill" style="font-size: 1em"></i>
            <span>Registered Asset</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link collapsed" href="pages/forms/staffreqaset.php">
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" href="pages/forms/dafaset.php">
            <i class="bi bi-pencil-square" style="font-size: 1em"></i>
            <span>Register New Asset</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link collapsed" href="pages/tables/laporanas.php">
            <i class="bi bi-file-earmark-text-fill" style="font-size: 1em"></i>
            <span>Asset & Inventory</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link collapsed" href="pages/tables/laporlupus.php">
            <i class="bi bi-file-earmark-x-fill" style="font-size: 1em"></i>
            <span>Disposal Report</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link collapsed" href="pages/tables/staffrequest.php">
            <i class="bi bi-check-circle-fill" style="font-size: 1em"></i>
            <span>Staff Request</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link collapsed" href="pages/forms/uploadcsv.php">
    ...
    <div class="row">
      ...
      <div class="col-xxl-4 col-md-6">
        <div class="card info-card revenue-card">
          <div class="card-body">
            <h5 class="card-title">Register New Category & Type</h5>
            ...
            <div class="d-flex align-items-center" style="margin-top: 10px">
              ...
              <div class="ps-3">
                <a href="pages/forms/tetapanAset.php">
                  <h6>Category & Type</h6>
                </a>
              </div>
            </div>
      ...
      <div class="col-xxl-4 col-md-6">
        <div class="card info-card sales-card">
          <div class="card-body">
            <h5 class="card-title">Register New Supplier</h5>
            ...
            <div class="d-flex align-items-center" style="margin-top: 10px">
              ...
              <div class="ps-3">
                <a href="pages/forms/dafPembekal.php">
                  <h6>Supplier</h6>
                </a>
              </div>
            </div>
