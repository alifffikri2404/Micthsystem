      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<!--<li>
		  ...
		  <ul class="treeview-menu">
            <li><a href="pages/forms/asetDaf.php"><i class="fa fa-circle-o"></i> Kategori</a></li>
		...
		<li class="treeview active">
		  ...
		  <ul class="treeview-menu">
            ...
            <li><a href="pages/tables/laporanas.php"><i class="fa fa-circle-o"></i> Rekod Aset</a></li>
			 <li class="active"><a href="#"><i class="fa fa-circle-o"></i> Tetapan</a></li>
          </ul>
        </li>
		<!--<li>
          <a href="pages/index.php">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-blue">
            <div class="inner">
              ...
              <p>Daftar Kategori Baru</p>
            </div>
            <div class="icon">
              <i class="ion ion-log-out"></i>
            </div>
            <a href="pages/forms/asetDaf.php" class="small-box-footer">Data Lengkap <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		<!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-black">
            <div class="inner">
              ...
              <p>Daftar Jenis Aset</p>
            </div>
            <div class="icon">
              <i class="ion ion-ios-paper"></i>
            </div>
            <a href="pages/forms/jenisAset.php" class="small-box-footer">Data Lengkap <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div> 
