...
$pdf->Write(0, 'Room Usage Record', '', 0, 'L', true, 0, false, false, 0);
...
$id = $_POST['id'];
$sql = "SELECT * FROM management_room WHERE user_id = '$id'" ;
...
if ($result->num_rows > 0) {
  while ($row = $result->fetch_assoc()) {
    ...
    $debitOutput .= '<td>' . $row["start_time"] . ' Untill ' . $row["end_time"] . '</td>';
...
$tbl .= '<td align="center" width="10%"><strong>USAGE TIME</strong></td>';
