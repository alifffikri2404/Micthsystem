      ...
      <ul id="booking-system-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
        ...
        <li class="nav-item">
          ...
          <ul id="book-room-nav" class="nav-content collapse show" data-bs-parent="#booking-system-nav">
            ...
            <li class="nav-item">
              <a class="active" href="../BookingSystem/add_room.php" style="padding-left: 60px">
      ...
      <div class="row">
        ...
        <div class="col-lg-20">
          <div class="row">
            ...
            <div class="sb">
              <div class="card-body">
                <h5 class="card-title"><strong>ADD ROOM</strong></h5>
                ...
                <form method="post" action="">
                  ...
                  <div class="row mb-3">
                    <div class="col-sm-10">
                      <button type="submit" class="btn btn-primary" name="add_room_btn">ADD</button>
                    </div>
                  </div>
