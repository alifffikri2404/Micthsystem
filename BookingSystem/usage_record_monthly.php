...
if (isset($_POST['submit3'])) {
  $id = $_POST['id'];
  header("Location: detailsadmin.php?id=$id");
  exit();
}
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Vehicle Record [Admin]</title>
        ...
        <ul id="booking-system-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li class="nav-item">
            ...
            <ul id="book-vehicle-nav" class="nav-content collapse show" data-bs-parent="#booking-system-nav">
              ...
              <li class="nav-item">
                <a class="active" href="usage_record_monthly.php" style="padding-left: 60px">
                ...
                <form action="" method="GET">
                  <div class="row">
                    ...
                    <div class="col-md-12 mt-2">
                      ...
                      <a href="usage_record_monthly.php" class="btn btn-danger">Reset</a>
                    </div>
                  </div>
                </form>
              </div>
...
<td><?php echo $row["start_date"]; ?></td>
                    ...
                    <?php
                      ...
                      echo "<tr><td colspan='5'>ERROR: " . $db->error . "</td></tr>";
                    }
                    ?>
                  </tbody>
                </table>
