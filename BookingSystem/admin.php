                        ...
                        <li class="list-group-item border-0 px-0">
                            <div class="form-check form-switch ps-0">
                                ...
                                <div class="table-responsive">
                                    <table class="reservation2-table table" id="datatable3">
                                        <thead>
                                            <tr>
                                                <th>USER</th>
                                                <th>ROOM</th>
                                        ...
                                        <tbody id="reservation2-body-room">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item border-0 px-0">
                            <div class="form-check form-switch ps-0">
                                ...
                                <!-- Responsive Table Wrapper -->
                                <div class="table-responsive">
                                    <table class="reservation2-table table" id="datatable2">
                                        <thead>
                                            <tr>
                                                <th>USER</th>
                                                <th>VEHICLE</th>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    roomFilterBtn.addEventListener('click', function() {
        ...
        const rows = document.querySelectorAll('#reservation2-body-room tr');
        rows.forEach(row => {
    ...
    .reservation2-table tr:nth-child(even) {
        background-color: #f9f9f9;
    }

    .reservation2-table tr:hover {
