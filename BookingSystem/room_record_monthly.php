      ...
      <ul id="booking-system-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
        ...
        <li class="nav-item">
          ...
          <ul id="book-room-nav" class="nav-content collapse show" data-bs-parent="#booking-system-nav">
            ...
            <li class="nav-item">
              <a class="active" href="../BookingSystem/room_record_monthly.php" style="padding-left: 60px">
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        $stmtMN = $db->prepare($sqlMN);
                        $stmtMN->bind_param("i", $ROOM);
                        $stmtMN->execute();
                        $resultMN = $stmtMN->get_result();

                        if ($resultMN && $resultMN->num_rows > 0) {
                          $rowMN = $resultMN->fetch_assoc();
                          $room_name = htmlspecialchars($rowMN['room_name']);
                        } else {
                          $room_name = "None";
                        }
                        $stmtMN->close();
                  ...
                  <?php
                    ...
                    // Display a message across all columns if no records found
