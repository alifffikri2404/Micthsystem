  ...
  if ($result) {
      echo "<script>
          if(confirm('Are you sure you want to cancel?')) {
              window.location.href = 'user_record.php'; // Redirect to room_user.php if cancellation is confirmed
          } else {
...
<head>
  ...
  <title>Vehicle Record Details</title>
      ...
      <ul id="booking-system-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
        ...
        <li class="nav-item">
          ...
          <ul id="book-vehicle-nav" class="nav-content collapse show" data-bs-parent="#booking-system-nav">
            ...
            <?php } ?>
            <li class="nav-item">
              <a class="active" href="../BookingSystem/user_record.php" style="padding-left: 60px">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="user_record.php">Vehicle Record</a></li>
                          ...
                          <div class="box-body">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-5">
                                <div class="form-group">
                                  ...
                                  <!--<div class="col-md-2">-->
                                  <input type="text" name="EMPLOYEE.NO" placeholder="Nama Kakitangan" value="<?php echo $employeeid ?>" class="form-control" readonly />
                                </div>
                              </div>
                            </div>
                            <br>
                            <div class="row">
                              ...
                              <div class="col-md-5">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="jenis_aset" style="text-transform:uppercase" placeholder="DESTINATION" value="<?php echo $fetched_row['destination']; ?>" class="form-control" readonly />
                                </div>
                              </div>
                            </div>
                            <br>
                            <div class="row">
                              <div class="col-md-5">
                                <div class="form-group">
                                  ...
                                  ?>
                                  <input type="text" name="no_siri" placeholder="VEHICLE" value="<?php echo $all ?>" class="form-control" readonly />
                                </div>
                              </div>
                              ...
                              <div class="col-md-5">
                                <div class="form-group">
                                  ...
                                  <!--<div class="col-md-2">-->
                                  <input type="text" name="no_aset" placeholder="PLAT.NO" value="<?php echo $fetched_row['model_plat']; ?>" class="form-control" readonly />
                                </div>
                              </div>
                            </div>
                            <br>
                            ...
                            <div class="row">
                              <div class="col-md-5">
                                ...
                                <div class="form-group">
                                  <input type="text" name="warranty" placeholder="REASON REJECT" value="<?php echo $fetched_row['sebab']; ?>" class="form-control" readonly />
                                </div>
                              </div>
                              <div class="col-md-5">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-5">
                                <label for="tarikh_serahan">STATUS:</label>
                                <div class="form-group">
                                  <input type="text" name="warranty" placeholder="REMARK" value="<?php echo $fetched_row['status']; ?>" class="form-control" readonly />
                                </div>
                              </div>
                            </div>
                          </div>
