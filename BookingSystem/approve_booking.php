...
<body>
     ...
     <li>
            <a href="approve_return.php">
              <i class="bi bi-circle"></i><span>Vehicle Return</span>
                ...
                <li>
            <a href="approve_booking.php" class="active">
  ...
  <div class="sb">
            <div class="card-body">
              <h5 class="card-title"><strong>VEHICLE BOOKINGS</strong></h5>
...
<?php
    $selectQuery = "SELECT * FROM `bookings` WHERE `status` LIKE 'Pend_BookApproval'";
