      ...
      <ul id="booking-system-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
        ...
        <li class="nav-item">
          ...
          <ul id="book-room-nav" class="nav-content collapse show" data-bs-parent="#booking-system-nav">
            ...
            <?php if ($_SESSION['admin_booking'] == "1") { ?>
            <li class="nav-item">
              <a class="active" href="../BookingSystem/dash_room.php" style="padding-left: 60px">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div id="calendar">
                            ...
                            echo build_calendar_room_admin($month, $year, $selectedRoom)
                    ...
                    <div class="order">
                            ...
                            <div class="row">
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  ...
                                  <a href="dash_room.php" class="btn btn-danger">Reset</a>
                                </div>
                              </div>
                            </div>
                          </form>
                      ...
                      <table class="table" id="DataTable">
                        ...
                        <tbody>
                          ...
                          $selectQuery = "SELECT * FROM `management_room` WHERE status NOT IN ('Reject', 'Release', 'Canceled') AND (start_date > '$current_date' OR (start_date = '$current_date' AND end_time >= '$current_time')) ORDER BY id DESC";
                          ...
                          ?>
                            ...
                            ?>
                            <tr>
                              <td colspan="6">No activity here</td>
                            </tr>
                          <?php
                          }
                          ?>
