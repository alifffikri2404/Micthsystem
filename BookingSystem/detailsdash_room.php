      ...
      <ul id="booking-system-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
        ...
        <li class="nav-item">
          ...
          <ul id="book-room-nav" class="nav-content collapse show" data-bs-parent="#booking-system-nav">
            ...
            <li class="nav-item">
              <a class="active" href="../BookingSystem/detailsdash_room.php" style="padding-left: 60px">
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <nav>
                ...
                <li class="breadcrumb-item"><a href="user_room.php">Room Details</a></li>
                        ...
                        <div class="table-data">
                            ...
                            <div class="row">
                                ...
                                $fullname = $row3['First_Name'] . ' ' . $row3['Last_Name'];
                                            ...
                                            <div class="col-md-6">
                                                <b><label for="Jabatan"
                                                        class="form-label">Department:</b><br><br><?php echo isset($row4['name']) ? $row4['name'] : 'N/A'; ?></label>
                                                <input required type="hidden" id="Jabatan" class="form-control"
                                                    value="<?php echo isset($row4['name']) ? $row4['name'] : ''; ?>" disabled>
                                        ...
                                        <div class="col-lg-7">
                                            ...
                                            <form class="row g-3" action="" method="post">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" id="staff_name" class="form-control" value="<?php echo $row3['First_Name']; ?>" disabled>
                                                </div>
                                                <?php
