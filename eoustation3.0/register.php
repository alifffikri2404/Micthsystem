                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <select type="text" class="form-select placeholder-label" id="manager" name="manager" placeholder="Manager" required>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <select type="text" class="form-select placeholder-label" id="department" name="department" placeholder="Department" required>
