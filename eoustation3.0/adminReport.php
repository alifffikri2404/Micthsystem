  ...
  <aside id="sidebar" class="sidebar">  
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li class="nav-item">
            <a href="adminReport.php" class="active">
              <i class="bi bi-calendar" style="font-size: 1em; background-color: transparent"></i><span>My Report</span>
            </a>
          </li>
          <li class="nav-item">
            <a href="checkHR.php">
              <i class="bi bi-pencil" style="font-size: 1em"></i><span>Check-Out</span>
            </a>
          </li>
          <li class="nav-item">
            <a href="tablefb.php">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="adminReport.php" class="btn btn-danger">Reset</a>
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    <tbody>
        ...
        if (isset($_GET['start_date']) && isset($_GET['end_date'])) {
            ...
            $sql = "SELECT * FROM outstation WHERE emp_no = '$emp_number' AND dateOut BETWEEN '$start_date' AND '$end_date'";
        } else {
        ...
        if ($result) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                <tr>
                    ...
                    <td><?php echo "$dateOut / $timeOut"; ?></td>
                    <td><?php echo "$dateIn / $timeIn"; ?></td>
                    <td>
                        <form method="POST">
        ...
        ?>
                ...
                <form action="tcpdf/laporanPDF/print_user.php" name="printForm" method="post" target="_blank">
                    ...
                    <button type="submit" class="btn btn-info" name="print">Print</button>
                </form>
                <script>
                ...
                if (isset($_POST["delete1"])) {
                    ...
                    if ($result) {
                        echo "<script>alert('Delete success.'); window.location='adminReport.php';</script>";
                    } else {
