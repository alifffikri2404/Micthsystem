...
function build_calendar($month, $year, $vehicle)
{
    ...
    if ($_SESSION['Job_Title'] == "9" || $_SESSION['Job_Title'] == "14" || $_SESSION['admin_surat'] == "1") {
        ...
        if ($date < date('Y-m-d')) {
            ...
            if (array_key_exists($date, $bookings) && ($done[$date] == 'Pending' || $done[$date] == 'Approved' || $done[$date] == 'Return')) {
                ...
                foreach ($bookings[$date] as $key => $userName) {
                    ...
                    $calendar .= "<td>$userName</td>";
                    $calendar .= "<td>$model</td>";
                    $calendar .= "<td>$startTime</td>";
                    $calendar .= "<td>" . $done[$date] . "</td></tr>";
                    $calendar .= "</tbody></table>";
                }
...
<style>
    ...
    .bx {
        ...
        width: 24px;
        /* Saiz bulatan yang sedikit lebih besar */
        height: 24px;
        ...
        /* Garis tepi yang lebih menonjol */
    ...
    .bx:hover {
        ...
        /* Gradien latar belakang berubah pada hover */
        transform: scale(1.1);
        /* Kesan pembesaran pada hover */
    }
