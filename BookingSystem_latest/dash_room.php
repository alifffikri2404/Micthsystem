    ...
    <div class="order">
        ...
        <table class="table" id="DataTable">
            ...
            <tbody>
                ...
                // Base query
                $selectQuery = "SELECT * FROM `management_room` WHERE status NOT IN ('Reject', 'Release', 'Canceled') AND (start_date > '$current_date' OR (start_date = '$current_date' AND end_time >= '$current_time'))";
