...
$pdf->writeHTML($html, true, false, true, false, '');
	...
	$sqlvtp = mysql_query("SELECT * FROM tbl_daftar_aset 
	...
	while ($result=mysql_fetch_array($sqlvtp))
	{
		...
		<tr>
			...
			<td align="center" style="letter-spacing: initial;">&nbsp;&nbsp;&nbsp;'.$result['nama_kategori'].'</td>
			<td align="left">&nbsp;&nbsp;&nbsp;'.$result['jenis_aset'].'</td>
			<td align="left">'.$result['no_siri'].'</td>
			<td align="left">'.$result['no_aset'].'</td>
			<td align="left" style="text-transform: capitalize;">'.$result['nama_aset'].'</td>
			<td align="center">'.$result['lokasi'].'</td>
			<td align="center">'.$result['cukai_jalan'].'</td>
