    ...
    <section class="section dashboard">
      <div class="row">
                ...
                <div class="table-data">
                  <div class="order">
                    ...
                    <thead>
                      ...
                      $statuses = ['Pending', 'Approved', 'Return'];

                      foreach ($statuses as $status) {
                        $selectQuery = "SELECT * FROM `management` WHERE `user_id` = $user_id AND `status` = '$status' ORDER BY `start_date` DESC";
                          ...
                          <tr>
                            ...
                            <td>
                              <span class="text-<?php echo ($status == 'Pending' ? 'info' : ($status == 'Approved' ? 'success' : 'warning')); ?> bold" name="status">
                                <?php echo ($status == 'Pending' ? 'Waiting Approval' : ($status == 'Approved' ? 'Approved' : 'Return')); ?>
                              </span>
                            </td>
                            <td>
        ...
        if(confirm('Are you sure you want to cancel?')) {
          // Optionally handle cancellation confirmation
        } else {
