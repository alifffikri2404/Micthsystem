  ...
  <div class="d-flex align-items-center justify-content-between">
    ...
    if ($result) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            // Show delete button if the user has the role of Manager
            if ($Job_Title == '9') {
                echo "<td>
                        <form method='POST'>
                            <input type='hidden' name='id' value='$id'>  
                            <button class='button btn btn-danger' type='submit' name='delete' id='delete' onclick='return checkdelete()'>Delete</button>
                        </form>
                      </td>";
            }
